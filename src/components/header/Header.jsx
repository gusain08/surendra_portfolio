...
import Cv from '../../assets/Cv_Surendra_singh.pdf'
            ...
            <>
              ...
              <header>
                ...
                <div className={`nav ${toggle && 'nav-left'}`}>
                    ...
                    <a className="header_button" href={Cv} target="_blank"><span className="button-text">Download CV</span> <span className="icon">
